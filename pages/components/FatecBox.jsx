export default function FatecBox() {
    return(
        <div className="w-screen bg-white flex flex-col p-10" id="fatec">
            <a className="font-semibold text-5xl text-indigo-500 text-center md:my-10 cursor-pointer" href="http://www.fateclins.edu.br/v4.0/">Fatec</a>
            <div className="w-full">
                <iframe
                    ...
                    height="600" style={{border:0}} loading="lazy"
