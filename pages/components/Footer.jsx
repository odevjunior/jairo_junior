export default function Footer() {
    return (
        <section className="w-screen md:h-96 bg-indigo flex flex-col align-center justify-center bg-gradient-to-r to-indigo-700 from-indigo-400">
            <h1 className="font-semibold text-5xl text-white text-center my-10">Contatos</h1>
            <div className="social-links flex flex-col md:flex-row align-center justify-center">
                <a href="https://www.linkedin.com/in/jairo-junior-496a4b14a/" className="w-10/12 md:w-1/12 h-28 m-5 flex flex-col align-center justify-center bg-white rounded-lg shadow-md">
                ...
                <a href="https://www.facebook.com/jairinho.junior.12/" className="w-10/12 md:w-1/12 m-5 h-28 flex flex-col align-center justify-center bg-white rounded-lg shadow-md">
                ...
                <a href="https://www.instagram.com/jairojunior.dev/" className="w-10/12 md:w-1/12 m-5 h-28 flex flex-col align-center justify-center bg-white rounded-lg shadow-md">
                ...
                <a href="https://github.com/odevjunior" className="w-10/12 md:w-1/12 m-5 h-28 flex flex-col align-center justify-center bg-white rounded-lg shadow-md">
